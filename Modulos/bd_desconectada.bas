...
End Function
Public Sub cargar_combo(combo As DataCombo, PK As String, CAMPO As String, TABLA As String, FILTRO As String, QUERY As String, ORDENACION As String)
    Dim rs As ADODB.Recordset
    Dim CONSULTA As String
    Dim s As String
    If QUERY <> "" Then
        CONSULTA = QUERY & " ORDER BY " & CAMPO & " " & ORDENACION
    Else
        If FILTRO <> "" Then
            s = " WHERE " & FILTRO & " "
        End If
    ...
    Set rs = Nothing
End Sub
Public Sub cargar_combo_FK(combo As DataCombo, PK As String, CAMPO As String, TABLA As String, FK_CAMPO As String, FK_VALOR As Long, FILTRO As String, QUERY As String, ORDENACION As String)
    Dim rs As ADODB.Recordset
    Dim CONSULTA As String
    Dim s As String
    If QUERY <> "" Then
