...
Begin VB.Form frmObras_Tarifas 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   330
   ClientWidth     =   9900
   Icon            =   "frmObras_Tarifas.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdborrar 
      ...
      Height          =   885
      Left            =   60
      Picture         =   "frmObras_Tarifas.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   7905
      Width           =   1065
   ...
   End
End
Attribute VB_Name = "frmObras_Tarifas"
...
Private Sub cmdAceptar_Click()
   ...
   On Error GoTo cmdAceptar_Click_Error
    ...
    oObra.ModificarFOferta pk, Format(FOFERTA, "yyyy-mm-dd")
    Set oObra = Nothing
    ' Tarifa
...
cmdAceptar_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdAceptar_Click of Formulario frmObras_Tarifas"
End Sub
...
Private Sub cmdImprimir_Click()
   ...
   On Error GoTo cmdImprimir_Click_Error
    ...
    p1(1) = "FIRMADO"
    p2(1) = USUARIO.getNOMBRE
    With frmReport
        .iniciar
        .CRITERIO = FILTRO
        .informe = "rptObras_Tarifa"
        .ParametrosNombre = p1
...
cmdImprimir_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdImprimir_Click of Formulario frmObras_Tarifas"
