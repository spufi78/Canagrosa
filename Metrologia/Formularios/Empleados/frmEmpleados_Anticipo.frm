...
Private Sub cmdImprimir_Click()
    ...
    Set docword = appword.Documents.Open(ReadINI(App.Path + "\config.ini", "documentos", "Informes") & "\Anticipo.doc")
    ' Cabecera
    ...
    docword.Tables(2).Rows.Last.Cells(1).Range.Text = "CON FECHA DE HOY HE RECIBIDO " & _
            ...
            ") EN CONCEPTO DE ANTICIPO DE MI NOMINA."
    If gOperario > 0 Then
...
Public Sub consulta_total()
    ...
    lbltotal = "Total anticipos : " & Format(ooa.total(gOperario), "currency")
End Sub
