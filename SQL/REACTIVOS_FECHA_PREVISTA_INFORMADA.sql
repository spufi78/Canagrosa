...
--     , b.DIAS_ENTREGA,  current_date, date_add(current_date,interval b.DIAS_ENTREGA DAY)
	  , if (concat(substr(a.CONFIRMADO,7,4),'-',substr(a.CONFIRMADO,4,2),'-',substr(a.CONFIRMADO,1,2)) < current_date,1,0) AS CADUCADO
