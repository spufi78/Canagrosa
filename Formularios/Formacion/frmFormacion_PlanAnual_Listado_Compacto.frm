...
Begin VB.Form frmFormacion_PlanAnual_Listado_Compacto 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   10350
      Picture         =   "frmFormacion_PlanAnual_Listado_Compacto.frx":0000
      Top             =   135
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmFormacion_PlanAnual_Listado_Compacto"
...
'Carga de lista de Documentos/PNT
    ...
    Dim rs As New ADODB.Recordset
    Dim oPlanDoc As New clsFormacion_plan_formacion_docs
