...
Begin VB.Form frmEquipos_Detalle_Mantenimiento 
   BackColor       =   &H00C0C0C0&
   ...
   ControlBox      =   0   'False
   Icon            =   "frmEquipos_Detalle_Mantenimiento.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Image imagen 
      Height          =   480
      Left            =   9450
      Picture         =   "frmEquipos_Detalle_Mantenimiento.frx":000C
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmEquipos_Detalle_Mantenimiento"
