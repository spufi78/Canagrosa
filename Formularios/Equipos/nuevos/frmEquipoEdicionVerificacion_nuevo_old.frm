...
Begin VB.Form frmEquipoEdicionVerificacion_nuevo_old 
   BackColor       =   &H00C0C0C0&
   ...
   Icon            =   "frmEquipoEdicionVerificacion_nuevo_old.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TrueDBGrid80.TDBGrid TDBGrid1 
            ...
            Columns(1).Caption=   "ID_RESULTADO"
            Columns(1).DataField=   ""
            ...
            _StyleDefs(36)  =   "Splits(0).Columns(0).Style:id=28,.parent=11,.alignment=2,.bgcolor=&HC1FFFF&"
            _StyleDefs(37)  =   ":id=28,.locked=0"
            _StyleDefs(38)  =   "Splits(0).Columns(0).HeadingStyle:id=25,.parent=12"
            _StyleDefs(39)  =   "Splits(0).Columns(0).FooterStyle:id=26,.parent=13"
            _StyleDefs(40)  =   "Splits(0).Columns(0).EditorStyle:id=27,.parent=15"
            _StyleDefs(41)  =   "Splits(0).Columns(1).Style:id=74,.parent=11"
            _StyleDefs(42)  =   "Splits(0).Columns(1).HeadingStyle:id=71,.parent=12"
            _StyleDefs(43)  =   "Splits(0).Columns(1).FooterStyle:id=72,.parent=13"
            _StyleDefs(44)  =   "Splits(0).Columns(1).EditorStyle:id=73,.parent=15"
            _StyleDefs(45)  =   "Named:id=37:Normal"
            _StyleDefs(46)  =   ":id=37,.parent=0,.alignment=3,.bgcolor=&H80000018&,.bgpicMode=2,.bold=0"
            _StyleDefs(47)  =   ":id=37,.fontsize=825,.italic=0,.underline=0,.strikethrough=0,.charset=0"
            _StyleDefs(48)  =   ":id=37,.fontname=MS Sans Serif"
            _StyleDefs(49)  =   "Named:id=38:Heading"
            _StyleDefs(50)  =   ":id=38,.parent=37,.valignment=2,.bgcolor=&H80000016&,.fgcolor=&H80000012&"
            _StyleDefs(51)  =   ":id=38,.wraptext=-1,.bold=0,.fontsize=825,.italic=0,.underline=0"
            _StyleDefs(52)  =   ":id=38,.strikethrough=0,.charset=0"
            _StyleDefs(53)  =   ":id=38,.fontname=MS Sans Serif"
            _StyleDefs(54)  =   "Named:id=39:Footing"
            _StyleDefs(55)  =   ":id=39,.parent=37,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
            _StyleDefs(56)  =   "Named:id=40:Selected"
            _StyleDefs(57)  =   ":id=40,.parent=37,.bgcolor=&H8080FF&,.fgcolor=&H0&,.bold=0,.fontsize=825"
            _StyleDefs(58)  =   ":id=40,.italic=0,.underline=0,.strikethrough=0,.charset=0"
            _StyleDefs(59)  =   ":id=40,.fontname=MS Sans Serif"
            _StyleDefs(60)  =   "Named:id=41:Caption"
            _StyleDefs(61)  =   ":id=41,.parent=38,.alignment=2"
            _StyleDefs(62)  =   "Named:id=42:HighlightRow"
            _StyleDefs(63)  =   ":id=42,.parent=37,.bgcolor=&H80000008&,.fgcolor=&H80000005&"
            _StyleDefs(64)  =   "Named:id=43:EvenRow"
            _StyleDefs(65)  =   ":id=43,.parent=37,.bgcolor=&HFFFFFF&,.wraptext=-1"
            _StyleDefs(66)  =   "Named:id=44:OddRow"
            _StyleDefs(67)  =   ":id=44,.parent=37,.bgcolor=&HD5ECF9&"
            _StyleDefs(68)  =   "Named:id=47:RecordSelector"
            _StyleDefs(69)  =   ":id=47,.parent=38"
            _StyleDefs(70)  =   "Named:id=50:FilterBar"
            _StyleDefs(71)  =   ":id=50,.parent=37"
         End
      ...
      Begin VB.CommandButton cmdMostrarEvaluacion 
         ...
         Height          =   360
         Left            =   7620
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   45
      ...
      Begin VB.CommandButton cmdAdjuntarEvaluacion 
         ...
         Height          =   360
         Left            =   6435
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":0261
         Style           =   1  'Graphical
         TabIndex        =   44
      ...
      Begin VB.CommandButton cmdEliminarEvaluacion 
         ...
         Height          =   360
         Left            =   7245
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":04D2
         Style           =   1  'Graphical
         TabIndex        =   43
      ...
      Begin VB.CommandButton cmdEscanearEvaluacion 
         ...
         Height          =   360
         Left            =   6840
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":0666
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton cmdEscanearHoja 
         ...
         Height          =   360
         Left            =   6840
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":0A20
         Style           =   1  'Graphical
         TabIndex        =   39
         ToolTipText     =   "Escanear documento"
         Top             =   2040
      ...
      Begin VB.CommandButton cmdEscanearCert 
         ...
         Height          =   360
         Left            =   6840
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":0DDA
         Style           =   1  'Graphical
         TabIndex        =   38
         ToolTipText     =   "Escanear documento"
         Top             =   2400
      ...
      Begin VB.CommandButton cmdEliminarLimitacion 
         ...
         Height          =   285
         Left            =   5580
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":1194
         Style           =   1  'Graphical
         TabIndex        =   35
      ...
      Begin VB.CommandButton cmdAnadirLimitacion 
         ...
         Height          =   285
         Left            =   5250
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":1328
         Style           =   1  'Graphical
         TabIndex        =   34
      ...
      Begin VB.ListBox lstLimitacionesUso 
         Appearance      =   0  'Flat
         Height          =   1395
         ItemData        =   "frmEquipoEdicionVerificacion_nuevo_old.frx":154D
         Left            =   1650
         List            =   "frmEquipoEdicionVerificacion_nuevo_old.frx":1554
         TabIndex        =   28
         Top             =   3540
         Width           =   4215
      End
      ...
      Begin VB.CommandButton cmdMostrarHojaCal 
         ...
         Height          =   360
         Left            =   7620
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":156C
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Ver norma"
         Top             =   2040
      ...
      Begin VB.CommandButton cmdAdjuntarHojaCal 
         ...
         Height          =   360
         Left            =   6435
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":17C1
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Buscar documento"
         Top             =   2040
      ...
      Begin VB.CommandButton cmdEliminarCertificado 
         ...
         Height          =   360
         Left            =   7245
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":1A32
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "Eliminar documento"
         Top             =   2400
      ...
      Begin VB.CommandButton cmdAdjuntarCertificado 
         ...
         Height          =   360
         Left            =   6435
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":1BC6
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Buscar documento"
         Top             =   2400
      ...
      Begin VB.CommandButton cmdMostrarCertificado 
         ...
         Height          =   360
         Left            =   7620
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":1E37
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Ver norma"
         Top             =   2400
      ...
      Begin MSComCtl2.DTPicker txtFechaActual 
         ...
         MinDate         =   2
      End
      Begin MSComCtl2.DTPicker txtFechaProxima 
         Height          =   405
         Left            =   9480
         TabIndex        =   3
         Top             =   765
      ...
      Begin VB.CommandButton cmdEliminarHojaCal 
         ...
         Height          =   360
         Left            =   7245
         Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":208C
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Eliminar documento"
         Top             =   2040
      ...
      Begin TrueDBGrid80.TDBGrid grdResultados 
         ...
         Columns(5).Caption=   "ID_TIPO"
         Columns(5).DataField=   ""
         Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(6)._VlistStyle=   0
         Columns(6)._MaxComboItems=   5
         Columns(6).Caption=   "ID_RESULTADO"
         Columns(6).DataField=   ""
         ...
         Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=1508"
         Splits(0)._ColumnProps(10)=   "Column(1)._EditAlways=0"
         ...
         Splits(0)._ColumnProps(20)=   "Column(3).Width=2117"
         Splits(0)._ColumnProps(21)=   "Column(3).DividerColor=0"
         Splits(0)._ColumnProps(22)=   "Column(3)._WidthInPix=2037"
         ...
         _StyleDefs(61)  =   "Splits(0).Columns(5).Style:id=58,.parent=11"
         ...
         _StyleDefs(65)  =   "Splits(0).Columns(6).Style:id=74,.parent=11"
         _StyleDefs(66)  =   "Splits(0).Columns(6).HeadingStyle:id=71,.parent=12"
         _StyleDefs(67)  =   "Splits(0).Columns(6).FooterStyle:id=72,.parent=13"
         _StyleDefs(68)  =   "Splits(0).Columns(6).EditorStyle:id=73,.parent=15"
         _StyleDefs(69)  =   "Named:id=37:Normal"
         _StyleDefs(70)  =   ":id=37,.parent=0,.alignment=3,.bgcolor=&H80000018&,.bgpicMode=2,.bold=0"
         _StyleDefs(71)  =   ":id=37,.fontsize=825,.italic=0,.underline=0,.strikethrough=0,.charset=0"
         _StyleDefs(72)  =   ":id=37,.fontname=MS Sans Serif"
         _StyleDefs(73)  =   "Named:id=38:Heading"
         _StyleDefs(74)  =   ":id=38,.parent=37,.valignment=2,.bgcolor=&H80000016&,.fgcolor=&H80000012&"
         _StyleDefs(75)  =   ":id=38,.wraptext=-1,.bold=0,.fontsize=825,.italic=0,.underline=0"
         _StyleDefs(76)  =   ":id=38,.strikethrough=0,.charset=0"
         _StyleDefs(77)  =   ":id=38,.fontname=MS Sans Serif"
         ...
         _StyleDefs(81)  =   ":id=40,.parent=37,.bgcolor=&H8080FF&,.fgcolor=&H0&,.bold=0,.fontsize=825"
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "Descripcion del Parámetro"
         ForeColor       =   &H80000008&
         Height          =   285
         Left            =   7470
         TabIndex        =   59
   ...
   Begin VB.Image imagen 
      Height          =   480
      Left            =   12045
      Picture         =   "frmEquipoEdicionVerificacion_nuevo_old.frx":2220
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmEquipoEdicionVerificacion_nuevo_old"
...
Private Sub cmdok_Click()
    ...
    If mvarenuTipoEdicion = ALTA Then
        ...
        lngId_Verificacion = mvarobjVerificacion.Insertar(True)
    Else
        lngId_Verificacion = CLng(mvarstrId)
        Call mvarobjVerificacion.Modificar(lngId_Verificacion, True)
    End If
...
On Error GoTo ComprobarDatos_Error
    ...
    If txtFechaActual.value >= txtFechaProxima.value Then
...
If mvarenuTipoEdicion = ALTA Then
    ...
    txtFechaProxima.value = calcularFechaProxima(mvardtmFechaProximaInicial, mvarlngIdPeriodoInicial)
    ...
    With mvarobjVerificacion
        ...
        Else
            ...
            'Else
                ...
                txtFechaProxima.value = CDate(.getFECHA_PROXIMA)
            'End If
        End If
...
Private Sub RecogerDatos()
    ...
    With mvarobjVerificacion
        ...
        If .getESTADO = 0 Then
            ...
            .setFECHA_PROXIMA = Format(txtFechaProxima.value, "dd/mm/yyyy")
        Else
...
If IsDate(txtFechaActual.value) Then
    txtFechaProxima.value = calcularFechaProxima(txtFechaActual.value, getDataComboSel(cmbPeriVerificacion))
End If
