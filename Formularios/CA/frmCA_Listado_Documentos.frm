...
Begin VB.Form frmCA_Listado_Documentos 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   1890
   ClientWidth     =   13680
   Icon            =   "frmCA_Listado_Documentos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   870
      Left            =   8280
      Picture         =   "frmCA_Listado_Documentos.frx":08CA
      Style           =   1  'Graphical
      TabIndex        =   29
      Top             =   8190
      Width           =   1920
   ...
   Begin VB.CommandButton cmdVigor 
      ...
      Height          =   870
      Left            =   6345
      Picture         =   "frmCA_Listado_Documentos.frx":1194
      Style           =   1  'Graphical
      TabIndex        =   28
      Top             =   8190
      Width           =   1875
   ...
   Begin VB.CommandButton cmdListadoAuditoria 
      ...
      Height          =   870
      Left            =   10260
      Picture         =   "frmCA_Listado_Documentos.frx":1A5E
      Style           =   1  'Graphical
      TabIndex        =   26
      Top             =   8190
      Width           =   1830
   ...
   End
End
Attribute VB_Name = "frmCA_Listado_Documentos"
...
Private Sub cargar_lista()
    ...
    NOMBRE = txtDatos(1)
    CODIGO = txtDatos(0)
    Set rs = oca_documentos.Listado(familia, subfamilia, ESTADO, NOMBRE, CODIGO, chkuso.value, chkENAC.value, chkNADCAP.value, chkEQA.value, responsable, chkcopia.value, chkFechas.value, fdesde, fhasta)
    lblsubtitulo = "Documentos listados : " & rs.RecordCount
