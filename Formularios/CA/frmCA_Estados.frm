...
Begin VB.Form frmCA_Estados 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Estados de documentos de calidad"
   ClientHeight    =   7365
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7170
   Icon            =   "frmCA_Estados.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmCA_Estados"
...
Private Sub cmdAnadir_Click()
    ...
    Else
        If MsgBox("Va a insertar el Estado. ¿Esta seguro?", vbYesNo + vbQuestion, App.Title) = vbYes Then
            Dim oFA As New clsCa_estados
...
Private Sub cmdEliminar_Click()
    If lista.ListItems.Count > 0 Then
        If MsgBox("Va a ELIMINAR el Estado. ¿Esta seguro?", vbYesNo + vbQuestion, App.Title) = vbYes Then
            Dim oFA As New clsCa_estados
...
Private Sub cmdModificar_Click()
    If txtDatos(0).Text = "" Then
        MsgBox "La descripción no puede estar en blanco.", vbCritical, App.Title
    Else
        If MsgBox("Va a modificar el Estado. ¿Esta seguro?", vbYesNo + vbQuestion, App.Title) = vbYes Then
            Dim oFA As New clsCa_estados
            oFA.setNOMBRE = txtDatos(0)
