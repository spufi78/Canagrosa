...
Begin VB.Form frmIndicadores_Lista 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Mantenimiento de Indicadores"
   ClientHeight    =   6930
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10380
   Icon            =   "frmIndicadores_Lista.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmIndicadores_Lista"
...
Private Sub cmdeliminar_Click()
    If MsgBox("Va a eliminar el indicador : " & lista.ListItems(lista.SelectedItem.Index), vbQuestion + vbYesNo, App.Title) = vbYes Then
        Dim oIndicadores As New clsIndicadores
        oIndicadores.Eliminar (lista.ListItems(lista.SelectedItem.Index).SubItems(3))
...
'        .Controls("titulo").Caption = "Listado de Indicadores"
'        .Controls("etiqueta4").Caption = "ID"
'        .Controls("etiqueta5").Caption = "Nombre"
'        .Controls("etiqueta10").Caption = "Frecuencia"
'        .Controls("etiqueta11").Caption = "Excel"
'    End With
...
'    Listado.Caption = "Listado de Indicadores"
...
Public Sub cabecera()
    With lista.ColumnHeaders.Add(, , "Nombre", 3000, lvwColumnLeft)
        .Tag = "Nombre"
    End With
    With lista.ColumnHeaders.Add(, , "Frecuencia", 2900, lvwColumnLeft)
        .Tag = "Frecuencia"
    End With
    With lista.ColumnHeaders.Add(, , "Hoja Excel", 3600, lvwColumnLeft)
        .Tag = "Hoja Excel"
    End With
