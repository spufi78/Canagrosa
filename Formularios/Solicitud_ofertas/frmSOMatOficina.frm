...
Begin VB.Form frmSOMatOficina 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Solicitud Oferta Material de Oficina"
   ClientHeight    =   3570
   ClientLeft      =   1575
   ClientTop       =   2625
   ClientWidth     =   12555
   ...
   Begin VB.CommandButton cmdCrearPediido 
      ...
      Index           =   0
      Left            =   1350
      Picture         =   "frmSOMatOficina.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   16
      Top             =   2640
      Visible         =   0   'False
   ...
   Begin VB.CommandButton cmd 
      ...
      Index           =   4
      Left            =   60
      Picture         =   "frmSOMatOficina.frx":08CA
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   2640
      Visible         =   0   'False
   ...
   Begin VB.Image Image1 
      Height          =   285
      Left            =   6990
      Picture         =   "frmSOMatOficina.frx":1194
      Stretch         =   -1  'True
      Top             =   1110
      Width           =   285
   End
   ...
   Begin VB.Label lblsubtitulo 
      ...
      AutoSize        =   -1  'True
      BackColor       =   &H00FFFFFF&
      Caption         =   "Detalle de la Solicitud de Oferta de Material de Oficina"
      ForeColor       =   &H80000008&
      Height          =   195
      Left            =   90
      TabIndex        =   4
   ...
   Begin VB.Image imagen 
      Height          =   480
      Left            =   11970
      Picture         =   "frmSOMatOficina.frx":1A5E
      Top             =   45
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmSOMatOficina"
