...
Begin VB.Form frmNC_Acciones 
   ...
   Begin VB.CommandButton cmdborrar 
      ...
      Height          =   930
      Left            =   45
      Picture         =   "frmNC_Acciones.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   6075
      Width           =   1065
   ...
   Begin TDBDate6Ctl.TDBDate TDBDate1 
      ...
      _ExtentX        =   2090
      _ExtentY        =   450
      Calendar        =   "frmNC_Acciones.frx":0BD4
      Caption         =   "frmNC_Acciones.frx":0CEC
      ...
      EndProperty
      DropDown        =   "frmNC_Acciones.frx":0D58
      Keys            =   "frmNC_Acciones.frx":0D76
      Spin            =   "frmNC_Acciones.frx":0DD4
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   0
   ...
   Begin VB.Image imagen 
      Height          =   420
      Left            =   13455
      Picture         =   "frmNC_Acciones.frx":0DFC
      Top             =   135
      Width           =   420
   End
   Begin VB.Label lbltitulo 
   ...
   End
End
Attribute VB_Name = "frmNC_Acciones"
...
cmdaceptar_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdaceptar_Click of Formulario frmNC_Acciones"
End Sub
