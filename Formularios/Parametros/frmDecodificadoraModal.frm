...
Begin VB.Form frmDecodificadoraModal 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   330
   ClientWidth     =   11895
   Icon            =   "frmDecodificadoraModal.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ScaleHeight     =   8040
   ...
   Begin VB.Image imagen 
      Height          =   480
      Left            =   11250
      Picture         =   "frmDecodificadoraModal.frx":08CA
      Top             =   135
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmDecodificadoraModal"
...
cmdAnadir_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdAnadir_Click of Formulario frmDecodificadoraModal"
End Sub
...
cmdModificar_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdModificar_Click of Formulario frmDecodificadoraModal"
End Sub
