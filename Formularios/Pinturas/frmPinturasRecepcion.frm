...
Begin VB.Form frmPinturasRecepcion 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Recepción de PINTURAS"
   ClientHeight    =   11505
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   13965
   ...
   Begin XtremeSuiteControls.Resizer Resizer1 
      ...
      Begin Geslab.ControlPanelXP cpprobetas 
         ...
         Begin TrueDBGrid80.TDBGrid gridA 
            ...
            Columns(6).Caption=   "Ref. Cliente"
            Columns(6).DataField=   ""
            Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
            Columns(7)._VlistStyle=   0
            Columns(7)._MaxComboItems=   5
            Columns(7).Caption=   "ID_ENSAYO"
            Columns(7).DataField=   ""
            Columns(7).NumberFormat=   "General Number"
            Columns(7).DropDown=   "tEstados"
            ...
            Splits(0)._ColumnProps(34)=   "Column(4).Width=4180"
            Splits(0)._ColumnProps(35)=   "Column(4).DividerColor=0"
            Splits(0)._ColumnProps(36)=   "Column(4)._WidthInPix=4101"
            ...
            Splits(0)._ColumnProps(52)=   "Column(6).Width=2725"
            Splits(0)._ColumnProps(53)=   "Column(6).DividerColor=0"
            Splits(0)._ColumnProps(54)=   "Column(6)._WidthInPix=2646"
            Splits(0)._ColumnProps(55)=   "Column(6)._EditAlways=0"
            Splits(0)._ColumnProps(56)=   "Column(6).Order=7"
            Splits(0)._ColumnProps(57)=   "Column(7).Width=4260"
            Splits(0)._ColumnProps(58)=   "Column(7).DividerColor=0"
            Splits(0)._ColumnProps(59)=   "Column(7)._WidthInPix=4180"
            Splits(0)._ColumnProps(60)=   "Column(7)._EditAlways=0"
            Splits(0)._ColumnProps(61)=   "Column(7)._ColStyle=1"
            ...
            _StyleDefs(62)  =   "Splits(0).Columns(5).Style:id=58,.parent=11,.alignment=2"
            ...
            _StyleDefs(66)  =   "Splits(0).Columns(6).Style:id=28,.parent=11,.bgcolor=&HC1FFFF&"
            _StyleDefs(67)  =   "Splits(0).Columns(6).HeadingStyle:id=25,.parent=12"
            _StyleDefs(68)  =   "Splits(0).Columns(6).FooterStyle:id=26,.parent=13"
            _StyleDefs(69)  =   "Splits(0).Columns(6).EditorStyle:id=27,.parent=15"
            _StyleDefs(70)  =   "Splits(0).Columns(7).Style:id=54,.parent=11,.alignment=2"
            _StyleDefs(71)  =   "Splits(0).Columns(7).HeadingStyle:id=51,.parent=12"
            _StyleDefs(72)  =   "Splits(0).Columns(7).FooterStyle:id=52,.parent=13"
            _StyleDefs(73)  =   "Splits(0).Columns(7).EditorStyle:id=53,.parent=15"
            _StyleDefs(74)  =   "Named:id=37:Normal"
            _StyleDefs(75)  =   ":id=37,.parent=0,.alignment=3,.bgcolor=&H80000018&,.bgpicMode=2,.bold=0"
            _StyleDefs(76)  =   ":id=37,.fontsize=825,.italic=0,.underline=0,.strikethrough=0,.charset=0"
            _StyleDefs(77)  =   ":id=37,.fontname=MS Sans Serif"
            _StyleDefs(78)  =   "Named:id=38:Heading"
            _StyleDefs(79)  =   ":id=38,.parent=37,.valignment=2,.bgcolor=&H80000016&,.fgcolor=&H80000012&"
            _StyleDefs(80)  =   ":id=38,.wraptext=-1,.bold=0,.fontsize=825,.italic=0,.underline=0"
            _StyleDefs(81)  =   ":id=38,.strikethrough=0,.charset=0"
            _StyleDefs(82)  =   ":id=38,.fontname=MS Sans Serif"
         ...
         Begin TrueDBGrid80.TDBGrid gridP 
            ...
            Splits(0)._ColumnProps(6)=   "Column(0).Order=1"
            Splits(0)._ColumnProps(7)=   "Column(1).Width=8520"
            Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
            Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=8440"
            ...
            Splits(0)._ColumnProps(26)=   "Column(4).Width=1508"
            Splits(0)._ColumnProps(27)=   "Column(4).DividerColor=0"
            Splits(0)._ColumnProps(28)=   "Column(4)._WidthInPix=1429"
            ...
            _StyleDefs(88)  =   ":id=40,.parent=37,.bgcolor=&H8080FF&,.fgcolor=&H0&,.bold=0,.fontsize=825"
   ...
   Begin VB.CommandButton cmdRA 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Datos R. Administrativa"
      Height          =   960
      Left            =   45
      Picture         =   "frmPinturasRecepcion.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   31
      Top             =   10485
      Width           =   1725
   ...
   Begin TDBDate6Ctl.TDBDate TDBDate1 
      ...
      _ExtentX        =   1376
      _ExtentY        =   503
      Calendar        =   "frmPinturasRecepcion.frx":08CA
      Caption         =   "frmPinturasRecepcion.frx":09E2
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmPinturasRecepcion.frx":0A4E
      Keys            =   "frmPinturasRecepcion.frx":0A6C
      Spin            =   "frmPinturasRecepcion.frx":0ACA
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   1
   ...
   Begin Geslab.ControlPanelXP cpDatos 
      ...
      _ExtentX        =   23760
      _ExtentY        =   5054
      Caption         =   "Datos de recepción de la Pintura"
      BackColor       =   12632256
      HeaderColor     =   8421504
      Object.Height          =   2865
      Begin MSDataListLib.DataCombo cmbCentro 
         Bindings        =   "frmPinturasRecepcion.frx":0AF2
         Height          =   315
         Left            =   10890
         TabIndex        =   43
         Top             =   1260
      ...
      Begin MSDataListLib.DataCombo cmbPedido 
         ...
         EndProperty
      End
      Begin pryCombo.miCombo cmbPintura 
         Height          =   330
         Left            =   1170
         TabIndex        =   1
         Top             =   855
   ...
   End
End
Attribute VB_Name = "frmPinturasRecepcion"
...
End Sub
Private Sub cmbPintura_Change()
    If cmbPintura.getPK_SALIDA <> 0 Then
        Dim oPintura As New clsPinturas
        oPintura.Carga cmbPintura.getPK_SALIDA
        If oPintura.getFICHA_ID = 0 Then
            txtproceso = ""
            If MsgBox("El baño no tiene ficha asignada. ¿Desea crearla?", vbYesNo + vbQuestion, App.Title) = vbYes Then
                frmBANO_Detalle.PK = cmbPintura.getPK_SALIDA
                frmBANO_Detalle.Show 1
            Else
                Exit Sub
            End If
        Else
            cargar_ficha cmbPintura.getPK_SALIDA, oPintura.getFICHA_ID
        End If
    End If
End Sub
...
Private Sub cmdok_Click()
   On Error GoTo cmdok_Click_Error
    ...
    If validar = True Then
        ...
        ' Generamos las muestras asociadas al tipo de analisis
        
        Dim i As Integer
        oce_recepcion.Calcular_Numero_Recepcion
        ' Generamos el registro de las muestras para los controles de eficacia
         ...
         If Not IsEmpty(xA(i, ColsA.ID_TIPO_ENSAYO)) Then
          If Trim(xA(i, ColsA.ID_TIPO_ENSAYO)) <> "" Then
            ...
            With oMuestra
                ...
                .setANULADA = 0
                .setPRECINTO = ""
                .setBANO_ID = cmbPintura.getPK_SALIDA
...
cmdok_Click_Error:
    Me.MousePointer = 0
    error_grave ("Error " & Err.Number & " (" & Err.Description & ") in procedure cmdok_Click of Formulario frmPinturasRecepcion")
End Sub

Private Sub cmdRA_Click()
    If PK > 0 Then
        frmPinturasRecepcionAdministrativa.PK = PK
...
validar_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure validar of Formulario frmPinturasRecepcion"
End Function
Private Sub cargar_combos()
    llenar_combo cmbClientes, New clsCliente, 0, Me, " ANULADA = 0"
    cargar_combo cmbCentro, New clsCentros
    llenar_combo cmbPintura, New clsPinturas, 0, Me, ""
...
End Sub
Private Sub cargar_ficha(PINTURA As Long, FICHA As Long)
   On Error GoTo cargar_ficha_Error
    ...
    Dim rs As ADODB.Recordset
    Set rs = oPinturaTA.Listado(PINTURA)
    If rs.RecordCount > 0 Then
        Do
...
'            xP(i, ColsP.TT) = CStr(rs(2))
    ...
    cmbLote.limpiar
    cmbLote.desactivar
    Set rs = oCe_bano_ensayos.Listado(PINTURA)
    If rs.RecordCount > 0 Then
        Do
...
cargar_ficha_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cargar_ficha of Formulario frmPinturasRecepcion"
End Sub
...
inicializar_grid_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure inicializar_grid of Formulario frmPinturasRecepcion_Nuevo2"
End Sub
      ...
      If Not IsEmpty(xA(i, ColsA.ID_TIPO_ENSAYO)) Then
        If Trim(xA(i, ColsA.ID_TIPO_ENSAYO)) <> "" Then
            ...
            ref = CStr(CANTIDAD & " PROBETAS: " & UCase(Trim(xA(i, ColsA.DESIGNACION))) & " " & _
                  txtsolucion & " BAÑO: " & cmbPintura.getTEXTO)
...
Private Sub cargarRadmin(ID As Long)
    Dim oPR As New clsPinturas_radmin
    If oPR.Carga(ID) Then
        cmbClientes.MostrarElemento oPR.getCLIENTE_ID
        cargar_pedidos oPR.getCLIENTE_ID, oPR.getFECHA_RECEPCION
        cmbPedido.BoundText = oPR.getPEDIDO_ID
    End If
    Set oPR = Nothing
End Sub
