...
Begin VB.Form frmInformeMuestrasPendientesCierre 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   330
   ClientWidth     =   12420
   Icon            =   "frmInformeMuestrasPendientesCierre.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdCerrarSinInforme 
      ...
      Height          =   870
      Left            =   3381
      Picture         =   "frmInformeMuestrasPendientesCierre.frx":08CA
      Style           =   1  'Graphical
      TabIndex        =   34
      Top             =   8055
      Width           =   1185
   ...
   Begin VB.CommandButton cmdMarcar 
      ...
      Height          =   870
      Left            =   30
      Picture         =   "frmInformeMuestrasPendientesCierre.frx":1194
      Style           =   1  'Graphical
      TabIndex        =   12
      Top             =   8055
      Width           =   1050
   ...
   Begin VB.CommandButton cmdDesmarcar 
      ...
      Height          =   870
      Left            =   1102
      Picture         =   "frmInformeMuestrasPendientesCierre.frx":15D6
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   8055
      Width           =   1050
   ...
   Begin VB.CommandButton cmdCerrar 
      ...
      Height          =   870
      Left            =   2174
      Picture         =   "frmInformeMuestrasPendientesCierre.frx":18E0
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   8055
      Width           =   1185
   ...
   End
End
Attribute VB_Name = "frmInformeMuestrasPendientesCierre"
