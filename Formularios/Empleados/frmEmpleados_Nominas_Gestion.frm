...
Begin VB.Form frmEmpleados_Nominas_Gestion 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   3495
   ClientWidth     =   14610
   Icon            =   "frmEmpleados_Nominas_Gestion.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame frmFechaCaducidad 
      ...
      Begin VB.CommandButton cmdInformar 
         ...
         Height          =   630
         Left            =   2790
         Picture         =   "frmEmpleados_Nominas_Gestion.frx":3AFA
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   225
         Width           =   1050
   ...
   Begin VB.CommandButton cmd_OR_GuardarCorreo 
      ...
      Height          =   870
      Left            =   7155
      Picture         =   "frmEmpleados_Nominas_Gestion.frx":A34C
      Style           =   1  'Graphical
      TabIndex        =   33
      Top             =   8685
      Width           =   960
   ...
   Begin VB.CommandButton cmdGestor 
      ...
      Height          =   870
      Left            =   6165
      Picture         =   "frmEmpleados_Nominas_Gestion.frx":A656
      Style           =   1  'Graphical
      TabIndex        =   32
      Top             =   8685
      Width           =   960
   ...
   Begin VB.CommandButton cmdVisualizar 
      ...
      Height          =   870
      Left            =   45
      Picture         =   "frmEmpleados_Nominas_Gestion.frx":AF20
      Style           =   1  'Graphical
      TabIndex        =   31
      Top             =   8685
      Width           =   960
   ...
   End
End
Attribute VB_Name = "frmEmpleados_Nominas_Gestion"
...
cmdGestor_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdGestor_Click of Formulario frmEmpleados_Nominas_Gestion"
...
CMDMOSTRAR_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdMostrar_Click of Formulario frmEmpleados_Nominas_Gestion"
End Sub
...
'    lbltitulo(1) = oDeco.getDESCRIPCION
    ...
    Dim CODIGO As Long
    If TOBJETO = TOBJETO_MUESTRAS Then
        If COBJETO <> 0 Then
            CODIGO = COBJETO
        Else
...
cmdAdjuntar_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmdAdjuntar_Click of Formulario frmEmpleados_Nominas_Gestion"
End Sub
...
lista_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure lista_Click of Formulario frmEmpleados_Nominas_Gestion"
End Sub
