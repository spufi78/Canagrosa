...
Public Property Let setQUERY(ByVal dato As String)
    QUERY = dato
End Property
Public Property Let setORDENACION(ByVal dato As String)
    ORDENACION = dato
End Property
...
Public Sub cargar_datos()
    If cargada = False Then
      CrearConexion
      If QUERY <> "" Then
        cargar_combo combo, PK, CAMPO, TABLA, FILTRO, QUERY, ORDENACION
      Else
        If FK_VALOR <> 0 And FK_CAMPO <> "" Then
            cargar_combo_FK combo, PK, CAMPO, TABLA, FK_CAMPO, FK_VALOR, FILTRO, QUERY, ORDENACION
        Else
            cargar_combo combo, PK, CAMPO, TABLA, FILTRO, QUERY, ORDENACION
        End If
      End If
